    ...
    return (
        <div style={{ margin: "0 10px" }}>
            <div class="card res-card" >
                <img src={data.cloudinaryImage} class="card-img-top res-product-img" alt="product" />
                <div class="card-body card-label-style">
                    <h5 class="card-title card-label-style text-center text-capitalize res-product-name">{data.name}</h5>
